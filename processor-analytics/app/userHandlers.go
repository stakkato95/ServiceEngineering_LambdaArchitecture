...
import (
	...
	"github.com/stakkato95/lambda-architecture/processor-analytics/dto"
...
func (h *UserHandlers) ReadUserCount(w http.ResponseWriter, r *http.Request) {
	count := h.service.GetUserCount()
	response := dto.UserCountResponse{Count: count}
